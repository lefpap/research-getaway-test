...
const DrawerContext = React.createContext<DrawerContextState>({
  direction: "bottom",
});
    ...
    <DrawerPortal>
      ...
      <DrawerPrimitive.Content
        ...
        className={cn(
          ...
          {
            "inset-x-0 bottom-0 mt-24 rounded-t-[10px]": direction === "bottom",
          },
          { "inset-x-0 top-0 mb-24 rounded-b-[10px]": direction === "top" },
          {
            "inset-0 right-auto w-screen max-w-80 sm:max-w-96 rounded-r-[10px]":
              direction === "left",
          },
          {
            "inset-0 left-auto w-screen max-w-80 sm:max-w-96 rounded-l-[10px]":
              direction === "right",
          },
          className,
        )}
